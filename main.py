...
from envs import AirSimDroneEnv

def train():

    env_name = "AirSimDroneEnv"
    ...
    env = AirSimDroneEnv(viz_image_cv2=False, observation_type="lidar")
    ...
    print("Weight file path : " + checkpoint_path)
    ...
    log_f.write('epoch,timestep,reward\n')
    ...
    while time_step <= max_training_timesteps:
        ...
        for t in range(1, max_ep_len+1):
            ...
            if time_step % print_freq == 0:
                ...
                print("Epoch : {} \t\t Timestep : {} \t\t Reward : {}".format(i_episode, time_step, print_avg_reward))
            ...
            if time_step % save_model_freq == 0:               
                ...
                print("Model saved")
                print("Training time: : ", datetime.now().replace(microsecond=0) - start_time)
                print("--------------------------------------------------------------------------------------------")
...
def test():
    ...
    for ep in range(1, total_test_episodes+1):
        ...
        print('Epoch: {} \t\t Reward: {}'.format(ep, round(ep_reward, 2)))
        ep_reward = 0
    ...
    print("Average Reward : " + str(avg_test_reward))
